...
namespace VulkanSimplifiedInternal
{
	...
	std::vector<IDObject<AutoCleanupUniformBufferDescriptorSet>> AutoCleanupNIFDescriptorPool::AllocateUniformBufferDescriptorSets(std::vector<VkDescriptorSetLayout> descriptorLayouts)
	{
		...
		if (_uniformBufferList.GetUnusedAndDeletedCapacity() < descriptorLayouts.size())
			throw std::runtime_error("AutoCleanupNIFDescriptorPool::AllocateUniformBufferDescriptorSets Error: Program tried to allocate more descriptor set than the maximum type amount allowed!");
	...
	void AutoCleanupNIFDescriptorPool::WriteUniformBufferDescriptorSets(const std::vector<UniformBufferDescriptorSetWriteDataInternal>& uniformBuffer)
	{
	...
	VkDescriptorSet AutoCleanupNIFDescriptorPool::GetUniformBufferDescriptorSet(IDObject<AutoCleanupUniformBufferDescriptorSet> descriptorSetID) const
	{
