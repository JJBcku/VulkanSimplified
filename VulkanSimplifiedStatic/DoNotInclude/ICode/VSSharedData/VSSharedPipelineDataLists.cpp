...
namespace VulkanSimplified
{
	...
	IDObject<VulkanSimplifiedInternal::VertexBindingDescriptionData> SharedPipelineDataList::AddVertexBindingData(uint32_t stride,
	...
	IDObject<VulkanSimplifiedInternal::VertexBindingDescriptionData> SharedPipelineDataList::AddUniqueVertexBindingData(uint32_t stride,
		VertexBindingInputRate inputRate, const std::vector<IDObject<VulkanSimplifiedInternal::VertexAttributeDescriptionData>>& vertexAttributeIDs,
		size_t addOnReserving)
	{
