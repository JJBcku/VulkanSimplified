...
{
	SharedPipelineDataListInternal::SharedPipelineDataListInternal(const VulkanSimplified::SharedPipelineDataListsCapacities& initialCapacities) :
	...
	IDObject<VertexBindingDescriptionData> SharedPipelineDataListInternal::AddVertexBindingData(std::uint32_t stride, VulkanSimplified::VertexBindingInputRate inputRate,
	...
	IDObject<VertexBindingDescriptionData> SharedPipelineDataListInternal::AddUniqueVertexBindingData(std::uint32_t stride, VulkanSimplified::VertexBindingInputRate inputRate,
		const std::vector<IDObject<VertexAttributeDescriptionData>>& vertexAttributeIDs, size_t addOnReserving)
	{
		VertexBindingDescriptionData add;
		add.stride = stride;
