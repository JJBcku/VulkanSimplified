...
namespace VulkanSimplifiedInternal
{
	...
	{
	public:
		PipelineDataListsInternal(const SharedPipelineDataListssInternal& pipelineData, const DescriptorDataListInternal& descriptorData, const ShaderListsInternal& shaderList,
